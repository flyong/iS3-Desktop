...
namespace IS3.Core
{
    ...
    public class Project
    {
        ...
        public bool loadDefinition(string file)
        {
            ...
            if (!projDef.LocalDatabaseName.ToLower().EndsWith("mdb"))
            {
                projDef.LocalDatabaseName = shortName;
            }
            // set dataservice path
            Globals.iS3Service.DataService.initializeDataService(projDef.LocalDatabaseName);
