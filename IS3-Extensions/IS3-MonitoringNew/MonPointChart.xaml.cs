        ...
        public void setObjs(IEnumerable<DGObject> objs)
        {
            ...
            foreach (DGObject obj in objs)
            {
                ...
                if (monPnt == null)
                    ...
                    if (monPnt.MonDatas==null || monPnt.MonDatas.Count==0)
                        continue;

                    List<MonReading> readings = monPnt.MonDatas;
                    if (readings.Count == 0)
                        continue;

                    Series series1 = new Series();
                    series1.Name = monPnt.name ;
                    series1.ChartType = SeriesChartType.FastLine;
                    series1.ChartArea = "ChartArea1";
                    series1.Points.DataBind(readings, "DataTime", "Value", null);
