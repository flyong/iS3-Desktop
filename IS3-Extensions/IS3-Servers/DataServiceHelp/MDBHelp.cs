...
{
    public static class MDBHelp
    {
        public static string connectionString { get { return "Provider=Microsoft.Jet.OLEDB.4.0; Data Source=" + _path; } }
        public static string _path = "";
        public static void SetConncetionString(string fileFullPath,string id="",string password="")
        {
            _path = fileFullPath;
            if (id != "")
            {
                _path += string.Format("; User Id = '{1}'; Password ='{2}' ", id, password);
            }
        }
        #region 公用方法    
