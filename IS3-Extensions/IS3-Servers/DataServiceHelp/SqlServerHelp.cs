...
namespace IS3.Servers.DataServiceHelp
{
    public static class SqlServerHelp
    {
        public static string connectionString { get { return "server="+ServerIP+";database=" + _path; } }
        public static string _path = "";
        public static string ServerIP="";
        public static string ServerUser = "";
        public static string ServerPwd = "";
        public static void SetConncetionString(string ServerIP,string fileFullPath, string id = "", string password = "")
        {
            _path = fileFullPath;
            SqlServerHelp.ServerIP = ServerIP;
            SqlServerHelp.ServerUser =id ;
            SqlServerHelp.ServerPwd = password;
            if (id != "")
            {
                _path += string.Format("; User Id = '{0}'; Password ='{1}' ", id, password);
            }
        }
        public static void SetConncetionString(string fileFullPath)
        {
            _path = fileFullPath;

            _path += string.Format("; User Id = '{0}'; Password ='{1}' ", ServerUser, ServerPwd);
        }
        #region 公用方法    
        public static int GetRecordCount(string TableNameSQL)
        {
            DataSet ds = Query("Select * from " + TableNameSQL);
        ...
        /// <param name="strSQL">查询语句</param>    
        /// <returns>SqlDataReader</returns>    
        public static SqlDataReader ExecuteReader(string SQLString, params OleDbParameter[] cmdParms)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            try
        ...
        private static void PrepareCommand(SqlCommand cmd, SqlConnection conn, SqlTransaction trans, string cmdText, OleDbParameter[] cmdParms)
        {
